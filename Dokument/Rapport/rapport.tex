...
%**TODO: "tänker undviks"?
Slutligen tänker undviks även onödigt komplexa funktioner som inte
...
%**TODO: "fysikaliskt korrekt" - plural samt kanske "helt" istället för "fysikaliskt" (eller avser ni att koppla till fysik?)
oss av exempel som inte nödvändigtvis är fysikaliskt korrekt. Målet är
...
%**TODO: "vårat" := "vårt" (på flera ställen)
Därefter tänker vi visa hur dessa definitioner eller formler skulle se ut i vårat DSL.
...
Vårat DSL ska vara uppbyggt från Haskell och ska täcka områdena TSS och Reglerteknik.
I båda kurserna så används komplexa tal vilket innebär att det först måste implementeras i vårat DSL.
