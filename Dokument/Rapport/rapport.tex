...
det matematiska språket. Se \appendixref{bil:exam_intervju} för
en sammanfattning av hela intervjun. Examinatorerna tror att
studenterna på Datateknik inte har tillräcklig vana att tolka
innebörden av de matematiska beskrivningarna och är allmänt ovana vid
matematiskt hantverk. De tror att datastudenterna därför lägger det
...
\internref{sec:didaktik}. Gruppen utvecklade och testade materialet,
...
kurserna \gls{tss} och \gls{regler}. Se \appendixref{bil:exam_intervju}
för en sammanfattning av denna intervju. Under intervjun redogjorde
...
beskriver valdes, som nämns i avsnitt \internref{sec:efterforskning},
...
ARCS-modellen som beskrivs i avsnitt \internref{sec:didaktik}.
...
avsnitt \internref{sec:efterforskning} för mer information om hur dessa delar
valts ut.
...
\internref{sec:diskussion} för vidare diskussion om detta.
...
\internref{sec:efterforskning}. De som sedan ville delta i testandet
...
Under intervjun med examinatorerna, se \internref{bil:exam_intervju},
