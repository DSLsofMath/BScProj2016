...
eventual further future development, see \url{https://github.com/DSLsofMath/BScProj}.
...
% TODO: Kolla på detta, jag har skrivit om lite här.
...
Detta avsnitt beskriver i korthet några studier som är nära relaterade
till vårt projekt.
...
beskrivningarna och är allmänt ovana vid matematiskt hantverk. De tror
att datastudenterna därför lägger det mesta av sin energi på att få
ihop matematiken rent praktiskt, istället för att se vad matematiken
står för.
...
%Todo: Här används "gruppen" nästan varje mening...
...
Dock konstaterades
%gruppen en bit in i projektet att det endast fanns tid att
...
text. Texten skrevs på ett sådant sätt att den är lätt att
ta till sig för målgruppen och uppmuntrar till vidare studier av
ämnet.

Delavsnitten innehåller även exempel på hur det aktuella ämnet
