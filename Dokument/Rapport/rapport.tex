...
\cite{didaktik_for_ingenjorslarare}.
\end{displayquote}
...
behöva lägga alltför mycket tid på hemsidans utseende. Bootstrap är
responsivt, vilket gör att hemsidan skalas om efter skärmstorleken utan att
man måste lägga massvis med tid på det, då detta inte är fokuset i projektet. 
På grund av detta är det även möjligt att gå in på hemsidan från en 
mobil ellersurfplatta, vilket gör det möjligt att använda materialet i fler
miljöer. En annan anledning till att Bootstrap användes var bland
annat CSS koden, vilka utgör designen på HTML koden, som redan
finns tillgänglig. Med hjälp av denna kod så så behövdes det inte läggas lika
mycket tid på designen av hemsidan utan det löstes för det mesta direkt.
