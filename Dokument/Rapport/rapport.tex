...
\cite{didaktik_for_ingenjorslararesid}.
\end{displayquote}
...
%Todo: Undvik radbyte här. " " := "~". Syftar på "I Didaktik för ingenjörslärare." 
...
%Todo: Det är en mellan rum -------------------------------^
%Som är förmodligen på grund av \internref. Jacob?
...
%Todo: Någor är med nedanför stycke, vet inte vad.
...
angripa matematiska problem genom att bygga
...
%Todo: Intern referens som ger ett mellanslag innan punkt.
...
%Todo: referens ger för stor mellanslag.
...
\cite{didaktik_for_ingenjorslararesid} beskriver aktivt lärande enligt
...
%Todo: Länk/hänvisning till exempel.
...
%Todo: Den fjärde kapitlet kommer visas i hemsidan va?
...
Under intervjun med examinatorerna, se \appendixref{bil:exam_intervju},
...
%Todo: Med varierande resultat? Syftar på "Projektgruppen består dock av fem studenter,
%vars erfarenhet inom området signal och systemlära var att fyra av dem läst kursen TSS.
...
%Todo: Vi har inte upprepat, för många gånger om varför vi inte tar upp regler
%och de andra transformerna? Har inte kollat men kommer ihåg att det tas
%upp igen i resultatdiskussionen. Lämnas som påminnelse.
...
Läromaterial som vårt är då i bästa fall ett \emph{socialt stöd}
...
redan läst kursen.
%Todo: Fråga 2 till 8 då? Säg också något mer konkret än.
