...
- \nameref{sec:didaktik}}. Gruppen utvecklade och testade materialet, se avsnitt \textit{\ref{sec:test}
- \nameref{sec:test}}, samt utvärderade och kompletterade det.
...
gapet mellan matematik och programmering. %Kanske formuleras om?
...
Läromaterial som vårt  är då i bästa fall ett \emph{social support} %finns det ett svenskt uttryck för detta?
