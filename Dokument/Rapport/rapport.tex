...
Här ovan så plockar funktionen \mintinline{realPart} ut den reella delen ur ett komplex tal och \mintinline{imPart} plockar ut den imaginära delan. 
...
Implementationen av den här representationen skedde i flera steg. Funktionen \mintinline{euler} skapar ett komplext tal utifrån en given vinkel, representerad av ett flyttal. %Tror vi kan ta bort paranteserna.
\begin{minted}{haskell}
