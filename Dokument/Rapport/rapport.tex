...
kurserna \acrlong{tss} och \acrlong{regler}. Se 
...
som läst kurserna \acrlong{tss} och \acrlong{regler}, eller skulle läsa
...
\gls{dsl} Som används i läromaterialet. Det andra avsnittet beskriver olika typer av signaler och
...
beskriver valdes, som nämns i föregående avsnitt,
...
förståelse av komplexa tal är en viktig förkunskap till \acrlong{tss}
valde projektgruppen att inleda med repetition av detta ämne. En annan
...
de läser \acrlong{tss}. Gruppen ville ge studenterna möjlighet att bekanta
...
begrepp i kursen \acrlong{tss} och kunskap om signaler är en nödvändig
grund för att förstå de följande avsnitten. Därför var det ett
självklart val för projektgruppen att låta andra avsnittet handla om detta. I
...
beskrivs i \acrlong{tss} är LTI-system. Kunskap om LTI-system och dess
egenskaper är därför avgörande för att förstå och räkna på de system
som tas upp i \acrlong{tss}. Avsnittet tar även upp faltning och hur detta
...
avsnitt \internref{sec:efterforskning} för mer information om hur
