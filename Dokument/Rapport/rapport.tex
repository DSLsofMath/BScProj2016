...
Läromaterial är då i bästa fall ett \emph{social support} som stödjer studenterna
med att få en bättre förståelse inom båda domänen. Detta skulle i så fall kunna både 
förbättra studenternas välbefinnande och möjligen även de individer dessa framtida ingenjörer kan komma att påverka i sitt arbete.
...
i \textit{\ref{sec:metDisk} - \nameref{sec:metDisk}} är detta ett relativt komplext problem
