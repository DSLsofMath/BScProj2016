...
till att ta fram läromaterial till endast en kurs, \gls{tss}. Något
material till kursen \gls{regler} har inte tagits fram, annat än
indirekt i form av förkunskaper. Läromaterialet som tagits fram är ett
...
kan godkänna. Eftersom koden lagras offentligt på \gls{GitHub} så är
