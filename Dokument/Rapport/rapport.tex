...
Materialet som utvecklats kan ses på
...
This report describes the development of the tutorial ``TSS med DSL''
...
The developed material can be viewed at
\url{https://github.com/DSLsofMath/BScProj}.
...
ett mate\-matiskt korrekt språk, matematiska bevis, avancerade
matematiska begrepp eller teorier. Anledningen till detta är att
materialet i första hand är tänkt att främja förståelse och väcka
intresse för ämnet. Detta beslut baserades även på boken
...
Reglerteknik har en ovanligt hög andel studenter som blir underkända
på tentamen. Under perioden 2010 till 2016 blev i genomsnitt endast
51\% av de som skrev tentamen i TSS godkända och under samma period
blev 53\% godkända i Reglerteknik \cite{tentastatistik}.
%Pajdiagram
...
122 registrerade studenter att inte tentera Reglerteknik 2014
...
intervjun.  Studenterna på Datateknik har inte tillräcklig vana att
tolka innebörden av de matematiska beskrivningarna och är allmänt
ovana vid matematiskt hantverk. Därför lägger datastudenterna det
mesta av sin energi på att få ihop matematiken rent praktiskt,
...
det skulle samlas på en hemsida. På detta sätt kan man enkelt samla
text, bilder och programmeringskod och presentera dem på ett
...
specifik domän. Att skapa domän\-specifika språk är ingenting nytt, det
finns tvärtom många DSL som används i vid utstäckning. Exempel på
några välkända DSL är HTML, MATLAB och Game Maker Language.
...
\gls{ARCS} är en akronym för \textit{Attention}, \textit{Relevance},
...
kurserna \textit{TSS} och \textit{Reglerteknik}. Se avsnitt
...
Z-transform. Som nämns i avsnittet \textit{\ref{sec:struktur} - \nameref{sec:struktur}} prioriterades detta bort på grund av tidsbrist i slutet av
