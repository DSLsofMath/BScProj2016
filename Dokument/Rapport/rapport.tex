...
% TODO: Skriv om "fixeras dessutom de givna parametrarna till en
% funktion ..." - jag förstår inte. Det är nog enklare att ge ett
% exempel - som plusEtt = (1+) eller dubbel = (2*).
