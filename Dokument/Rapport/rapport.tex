...
\end{minted}
Sedan implementerades även sinus- och cosinusfunktioner med hjälp av Eulers formel.
Så här representeras sinus som ett komplext tal:
$\sin(x) = (e^{ix} - e^{(-ix)}) / 2i$
