%TODO: Undvik termen "mjukvara" till förmån för "program" eller "programvara": http://www.datatermgruppen.se/visning.html?obj=a78
...
Allt skrivet material finns på \url{https://github.com/} ifall man vill ta del av eller arbeta vidare med handledningen.
...
kurser eftersom handledningen kan förbättras så att den även täcker alla matematik relaterade kurser. Det slutgiltiga 
...
från \url{http://learnyouahaskell.com/} och ett sammanhang(röd tråd?) för alla exempel i varje avsnitt. %Om det känns som om ett exempel fortsätter från ett tidigare exempel vilket enligt Relevance visar hur allt relaterar till modelleringen av ett system.

Dessutom behöver handledningen några bilder skilt från grafer men är fortfarande relevanta till exemplen i texten. %Jag tänker mig i fallet med smoothien så kunde vi ta med en smoothie bara för att få en klarare bild med exemplen. Tyckte det hjälpte när jag läste igenom learnyousomeerlang.

Bilderna kommer hjälpa till med att hålla elevernas uppmärksamhet vilket är den första grundpelaren i ARCS-modellen. %Och grafer ses allmänt som tråkiga och tillhörande det matematiska språket såvida de inte är väldigt förklarande.

Tillslut så behövs en implementation för kontinuerliga operatorer. %Eller förbättringar?
