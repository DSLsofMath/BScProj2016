...
text mellan olika språk. Endast ett fåtal manuella kompletteringar
...
hemsidan. Skulle man ha mer efarenhet av att arbeta med HTML skulle
man kunnat redigera i LaTeX för att sedan generera HTML koden igen,
men det hittades ingen simpel lösning till att göra detta samtidigt
som strukturen behölls.

Vid arbete med uppgifter så användes jQuery, vilket är ett JavaScript-
bibliotek, för att göra det lättare att arbeta med JavaScript. JQuery
ansågs mer lättläsligt än vanlig JavaScript och det blir därmed
lättare att felsöka i koden.

När det kom till designen av hemsidan användes verktyget
...
använda vilken skärm man har tillgänglig, vare sig det är en dator
eller mobil, utan att hemsidan blir dåligt optimerad, vilket skulle
distrahera läsaren bort från texten vilket aldrig är något att sträva
efter.
