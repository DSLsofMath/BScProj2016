...
%fokusera på fouriertransformen eftersom den är nära besläktad med laplacetransformen och Z-transformen.%, dessa kan i det närmaste betraktas som specialfall av fouriertransformen. -Inte säker om detta stämmer för Z.
%Detta repeteras också mycket från metod. Tycker det är bra om vi bara tar bort det liksom.
...
Dessutom behöver läromaterialet några bilder skilt från grafer men är fortfarande relevanta till exemplen i texten. %Jag tänker mig i fallet med smoothien så kunde vi ta med en smoothie bara för att få en klarare bild med exemplen. Tyckte det hjälpte när jag läste igenom learnyousomeerlang.
