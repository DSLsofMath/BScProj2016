...
%TODO: Det ser lite tomt ut med bara två rader i ordlistan. Ni kan väl ta med "DSLsofMath" (med titel, kurskod och en länk till kursen eller projektet), Haskell och kanske något mer.
...
%TODO: varför är titeln på materialet på engelska när själva materialet är på svenska?
...
The tutorial also includes programming exercises using domain specific languages
written in Haskell.

The background to this project is that the computer science students studying the course ``Transforms, Signals and Systems'' have gotten poor results for several years due to the students' unfamiliarity with the kind of mathematics which is necessary for that course. As it turned out this is a general problem and not unique to Computer science students at Chalmers.

The report further describes the surveys and analyses done in order to produce this tutorial and the test results from the finished product.
...
\section{Inledning}
%TODO: undvik "kommer att" och gör texten mer direkt: "Vi inleder med ..."
...
%TODO: definiera en förkortning med \gls
...
%TODO: tydliggör skillnaden mellan projekt och projekt - kanske med "kandidatprojekt" för er del?
...
%TODO: trevligt kort namn "TSS med DSL" - definiera gärna en förkortning i glossary och länka där till handledningen
...
%TODO: Skriv "Github" eller "GitHub" - inte båda.
...
%TODO: skriv "git" eller "Git" - inte båda. Se nedan.
För ytterligare information om Git se hemsidan \url{https://git-scm.com}.

%TODO: skriv "git" eller "Git" - inte båda. Se ovan.
...
%TODO: "konstruktor" := "konstruerare" (här och på ett par ställen till)
...
%TODO: "korresponderande" := "motsvarande"
...
%TODO: Ändra så att citeringen görs i löpande text och inte "Hänger lös" i början av en rad.
...
studenter och lärare möjlighet att ge sina åsikter på ändringar med mera.

När de olika delarna i läromaterialet blivit färdiga så skrevs dem över till HTML, med hjälp av Pandoc, för att kunna
skapa en hemsida så att det blir mer lätt\-åtkomligt. Pandoc är ett program som översätter text mellan olika märkspråk och
...
bearbetade vi deras feedback, utvärderade och såg ifall vi hittade några större fel eller delar som vi tyckte att vi
...
%TODO: det ligger en mattekurs i LP1 i D2 numera.
...
begriplig.  \textit{The Fastest Fourier Transform in the West} %https://hackage.haskell.org/package/fft-0.1.8.3/docs/Math-FFT.html
...
%TODO: Byt ut alla dessa "handgjorda" referenser till riktiga LaTeX-referenser - kanske något i stil med mitt exempel nedan.
...
%TODO: Ett intressant tillägg kunde vara att också reflektera över ert eget lärande: är utveckling av kursmaterial ett bra sätt att lära sig? I så fall kanske en del "future work" med fördel kunde utvecklas av andra studenter på programmet som ett led i deras lärprocess!
