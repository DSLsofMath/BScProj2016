...
% Använda biblatex med ieee-stil
\usepackage[backend=biber,style=ieee]{biblatex}
\addbibresource{include/referenser.bib}

% Använd glossaries och lägg tikl ordlistan
...
% Fix table of contents to fit in one page
...
% Consistent intern references
\newcommand{\internref}[1]{\textit{\ref{#1} - \nameref{#1}}}

\newcommand{\appendixref}[1]{\textit{bilaga \ref{#1}}}
