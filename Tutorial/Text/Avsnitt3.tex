...
\[C_k = \sum_{k=-\infty}^{\infty} C_k e^{k j t}\] %Finns det en anledning till varför det är en summa? Brukar det inte vara en integral? Var detta jag som råkade skriva detta?
