...
%Det kan kanske vara bra att flytta ner exemplet. Det är ju inte så dumt att avsluta med ett stort exemplel där man tar upp i princip allt man gått igenom. Men i så fall är det nog bra om man kan lägga till ett annat exempel på Fouriertransform här.
