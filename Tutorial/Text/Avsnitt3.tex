...
%TODO: ovan skrev ni bara om "fouriertransform" - inte "fourierserier"
...
%TODO: Vänligen byt ut $$ matematik $$ mot \[matematik\] så blir det lättare att hitta fel ifall ni glömmer en "slut på matematik"-parentes.
$$sin(\omega_0 t) = \frac{e^{j \omega_0 t}  - e^{-j \omega_0 t}}{2i}$$
%TODO: det bör vara "en ... serie" (inte serier) och "ett exempel"
...
Sen finns även Plancherel's ekvation: %Parservals
%$$ 2 \pi <f,f> = <F,F> $$
...
%TODO: stavning: "vänsterleden" och längre ned "högerledet" (undvik särskrivning)
