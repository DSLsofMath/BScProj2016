...
%TODO: Den här definition stämmer inte med Haskell-koden (Tutorial/Kod/ComplexNumbers.lhs) och har skum indentering.
\begin{minted}{haskell}
...
%TODO: Även här är det den "gamla typen Complex" som används
\begin{minted}{haskell}
    abs z           = Complex (hyp, 0)
        where hyp   = ...
              r      = realPart z
...
\end{minted}
\textbf{Övning 3:}
%TODO: Fixa typen på Complex (och ovanlig radbrytning)
\begin{minted}{haskell}
instance Num Complex where
