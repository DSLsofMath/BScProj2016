...
%TODO: Tips: för att skriva "vanlig text" i math mode kan man använda \mbox{vanlig text}. Då slipper man "\;" och får rätt typsättning av texten etc. Då är det också lämpligt att "kliva tillbaka" till math mode för de variabler man hänvisar till: \mbox{($a$ är en konstant}
...
%TODO: Tips: använd \mbox{(där $a$ och $b$ är konstanter)} eller liknande
...
%TODO: notationen med [n-k] behöver förklaras mer (eller ändras). Detta verkar bara gälla en periodisk sekvens (som ni inte tagit upp). -Pending
...
%Välj den variant ni tror användes i kursen vilket lämnas till gruppen.
